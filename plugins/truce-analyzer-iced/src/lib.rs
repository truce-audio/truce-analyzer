...
#[derive(Params)]
pub struct TruceAnalyzerIcedParams {
    #[param(name = "Gain", range = "linear(-60, 6)",
            unit = "dB", smooth = "exp(5)")]
    pub gain: FloatParam,
}

use TruceAnalyzerIcedParamsParamId as P;

pub struct TruceAnalyzerIced {
    params: Arc<TruceAnalyzerIcedParams>,
}

impl TruceAnalyzerIced {
    pub fn new(params: Arc<TruceAnalyzerIcedParams>) -> Self {
        Self { params }
    }
}
...
impl PluginLogic for TruceAnalyzerIced {
    ...
    fn layout(&self) -> truce_gui::layout::GridLayout {
        ...
        GridLayout::build("TruceAnalyzerIced", "V0.1", 2, 80.0, vec![
...
truce::plugin! {
    logic: TruceAnalyzerIced,
    params: TruceAnalyzerIcedParams,
